...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 08. Dez 2022 um 13:33
...
(1, 'Peter', 'Schmitt', NULL, 'Peter.Schmitt202@gmail.com', '1238/129416'),
...
--
ALTER TABLE `tbl_ansprechpartner`
  MODIFY `PK_ansprechpartner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT für Tabelle `tbl_gebaeude`
--
ALTER TABLE `tbl_gebaeude`
  MODIFY `PK_gebaeude` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_raum`
  MODIFY `PK_raum` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
